          ...
          <div class="w-full md:w-1/2 flex flex-col justify-center items-center overflow-y-auto px-6 py-8 md:px-12 lg:px-20 bg-white">
              <div class="w-full max-w-md space-y-5 text-left my-auto">
                  ...
                  <div class="pt-3 border-t border-slate-100 flex flex-col gap-2">
                      <span class="text-[9px] font-black uppercase text-slate-400 tracking-widest text-center">Demo Quick Register Bypass</span>
                      <button @click="quickRegister" type="button" class="w-full bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-[9px] font-bold py-2 rounded uppercase tracking-wider transition-colors cursor-pointer text-center">
                          Quick Register Citizen Account
                      </button>
                  </div>
